...
class TabNode extends Node implements IDraggable {
     ...
     * WILL be saved to the json. The config attribute should be changed via the action Actions
     * updateNodeAttributes rather than directly, for example:
