...
class Actions {
    ...
    public static addNode(json: any, toNodeId: string, location: DockLocation, index: number): Action {
        return new Action(Actions.ADD_NODE, { json, toNode: toNodeId, location: location.name, index });
    }
     ...
     */
    public static adjustSplit(splitSpec: ISplitSpec): Action {
